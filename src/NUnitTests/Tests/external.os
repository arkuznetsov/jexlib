...
Процедура ТестДолжен_СоздатьКомпоненту() Экспорт
	...
	юТест.ПроверитьРавенство(ТипЗнч(ИзвлечениеДанных), Тип("ИзвлечениеДанныхJSON"), "Не удалось создать компоненту ИзвлечениеДанныхJSON"); 
...
Процедура ТестДолжен_ИзвлечьДанныеИзФайлаJSON() Экспорт
	...
	ИзвлечениеДанных.ОткрытьФайл(ПутьКФайлу);
...
Процедура ТестДолжен_ИзвлечьСоответствиеИзJSON() Экспорт
	...
	Сообщить(СтрШаблон("Тип результата: %1", ТипЗнч(Результат)));
